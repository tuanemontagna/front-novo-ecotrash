...
export const metadata = { title: "Recuperar Senha - EcoTrash" };
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col items-center justify-center gap-8 bg-[linear-gradient(135deg,#48742c_0%,#3a5e23_100%)] px-12 py-16 text-center text-white">
        ...
        <p className="max-w-md text-lg leading-relaxed font-medium">Recupere seu acesso</p>
        <p className="max-w-md text-sm opacity-80 leading-relaxed">Não se preocupe, vamos ajudar você a voltar a transformar o mundo.</p>
      </div>
      ...
      <div className="flex items-center justify-center bg-white px-6 py-16 md:px-12">
        <div className="w-full max-w-md space-y-10">
          <div className="space-y-2 text-center md:text-left">
            <h2 className="text-2xl font-bold text-[#2d5016]">Esqueceu a senha?</h2>
            <p className="text-sm text-zinc-600">Digite seu email para receber as instruções de redefinição.</p>
          </div>
          <RecoverPasswordForm />
        </div>
      </div>
